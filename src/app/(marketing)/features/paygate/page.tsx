        ...
        <div className="bg-black">
            ...
            <section className="relative py-24 md:py-32 text-center">
                ...
                <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
                        Get Paid Faster<br />
                        <span className="text-white/50">with PayGate</span>
                    </h1>
            ...
            <section className="py-16">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    <p className="text-center text-white/40 text-sm mt-4">Connect your preferred payment provider in minutes</p>
                </div>
            </section>
                        ...
                        <div className="border border-white/10 rounded-3xl bg-black/50 overflow-hidden">
                            ...
                            <div className="p-8">
                                ...
                                <div className="border-t border-white/10 pt-6">
                                    <Button className="w-full bg-white text-black hover:bg-white/90 rounded-xl h-14 text-lg font-medium">
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
                        {paymentProviders.map((provider, i) => (
                            <div key={i} className="p-6 rounded-2xl bg-white/2 border border-white/5 text-center">
                                ...
                                <div className={`text-xs ${provider.status === "Primary" ? "text-white" : provider.status === "Available" ? "text-white/50" : "text-white/30"}`}>
                                    {provider.status}
                                </div>
                            </div>
                        ))}
