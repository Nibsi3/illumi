        ...
        <div className="min-h-screen bg-black text-white grainy-gradient">
            ...
            <main className="relative z-10 mx-auto max-w-6xl px-6 pt-32 md:pt-40 pb-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                    <div className="rounded-2xl border border-red-500/20 bg-[#0a0a0a] p-8">
                        ...
                        <div className="space-y-6">
                            <div>
                                <div className="text-sm text-white/60 mb-1">Time Per Invoice</div>
                                <div className="text-4xl font-bold text-red-400">22 min</div>
                            </div>

                            <div>
                                <div className="text-sm text-white/60 mb-1">Monthly Time Cost (20 invoices)</div>
                            ...
                            <div>
                                <div className="text-sm text-white/60 mb-1">Payment Delays from Errors</div>
                                <div className="text-4xl font-bold text-red-400">+12 days</div>
                            </div>
                        </div>
                    </div>

                    <div className="rounded-2xl border border-green-500/20 bg-[#0a0a0a] p-8">
                        <h2 className="text-2xl font-semibold mb-6 flex items-center gap-3">
                    ...
                    <div className="space-y-6">
                        <div className="rounded-xl bg-white/5 p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    <div className="text-xs text-white/40 mb-1">Hours Saved Per Year</div>
                                    <div className="text-2xl font-bold text-white">75.6 hours</div>
                                </div>
                                <div>
                                    <div className="text-xs text-white/40 mb-1">Value at R 500/hour</div>
                                    <div className="text-2xl font-bold text-green-400">R 37,800</div>
                                </div>
                                <div>
                                    <div className="text-xs text-white/40 mb-1">Efficiency Gain</div>
                        ...
                        <div className="rounded-xl bg-white/5 p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    <div className="text-xs text-white/40 mb-1">Payment Time Reduction</div>
                                    <div className="text-2xl font-bold text-white">-11 days</div>
                                </div>
                                <div>
                                    <div className="text-xs text-white/40 mb-1">Cash Flow Improvement</div>
                                    <div className="text-2xl font-bold text-green-400">R 48,000</div>
                                </div>
                                <div>
                                    <div className="text-xs text-white/40 mb-1">Opportunity Cost Saved</div>
                        ...
                        <div className="rounded-xl bg-white/5 p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    <div className="text-xs text-white/40 mb-1">Errors Prevented</div>
                                    <div className="text-2xl font-bold text-white">38/year</div>
                                </div>
                                <div>
                                    <div className="text-xs text-white/40 mb-1">Correction Time Saved</div>
                                    <div className="text-2xl font-bold text-green-400">19 hours</div>
                                </div>
                                <div>
                                    <div className="text-xs text-white/40 mb-1">Value of Error Prevention</div>
                        ...
                        <div className="rounded-xl bg-green-500/10 border border-green-500/20 p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    <div className="text-sm text-white/60 mb-2">Total Annual Savings</div>
                                    <div className="text-4xl font-bold text-green-400">R 52,100</div>
                                </div>
                                <div className="text-right">
                                    <div className="text-sm text-white/60 mb-2">Software Cost (Illumi Pro)</div>
                                    <div className="text-2xl font-bold text-white">R 4,200/year</div>
                                </div>
                            </div>
                            <div className="mt-6 pt-6 border-t border-green-500/20">
                                <div className="flex items-center justify-between">
                                    <div className="text-lg font-semibold text-white">Net Annual Benefit</div>
                                    <div className="text-4xl font-bold text-green-400">R 47,900</div>
                                </div>
                                <div className="text-sm text-white/60 mt-2">ROI: 1,140% | Payback period: 0.9 months</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-8 mb-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="rounded-xl bg-white/5 p-6">
                            <h3 className="font-semibold mb-3 text-white">Professional Image</h3>
                        ...
                        <div className="rounded-xl bg-white/5 p-6">
                            <h3 className="font-semibold mb-3 text-white">Better Record Keeping</h3>
                            <p className="text-sm text-white/60 leading-relaxed">
                        ...
                        <div className="rounded-xl bg-white/5 p-6">
                            <h3 className="font-semibold mb-3 text-white">Payment Tracking</h3>
                            <p className="text-sm text-white/60 leading-relaxed">
                        ...
                        <div className="rounded-xl bg-white/5 p-6">
                            <h3 className="font-semibold mb-3 text-white">Scalability</h3>
                            <p className="text-sm text-white/60 leading-relaxed">
                        ...
                        <div className="rounded-xl bg-white/5 p-6">
                            <h3 className="font-semibold mb-3 text-white">Analytics & Insights</h3>
                            <p className="text-sm text-white/60 leading-relaxed">
                        ...
                        <div className="rounded-xl bg-white/5 p-6">
                            <h3 className="font-semibold mb-3 text-white">Online Payment Integration</h3>
                            <p className="text-sm text-white/60 leading-relaxed">
                ...
                <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-8 mb-12">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between p-4 rounded-xl bg-white/5">
                            <div>
                                <div className="font-semibold text-white">5 invoices/month (Freelancer)</div>
                                <div className="text-sm text-white/60">Saves 1.6 hours/month</div>
                            </div>
                            <div className="text-right">
                                <div className="text-2xl font-bold text-green-400">R 9,600/year</div>
                                <div className="text-xs text-white/40">229% ROI</div>
                            </div>
                        </div>

                        <div className="flex items-center justify-between p-4 rounded-xl bg-white/5">
                            <div>
                                <div className="font-semibold text-white">20 invoices/month (Small Business)</div>
                                <div className="text-sm text-white/60">Saves 6.3 hours/month</div>
                            </div>
                            <div className="text-right">
                                <div className="text-2xl font-bold text-green-400">R 47,900/year</div>
                                <div className="text-xs text-white/40">1,140% ROI</div>
                            </div>
                        </div>

                        <div className="flex items-center justify-between p-4 rounded-xl bg-white/5">
                            <div>
                                <div className="font-semibold text-white">50 invoices/month (Growing Business)</div>
                                <div className="text-sm text-white/60">Saves 15.8 hours/month</div>
                            </div>
                            <div className="text-right">
                                <div className="text-2xl font-bold text-green-400">R 118,600/year</div>
                                <div className="text-xs text-white/40">2,724% ROI</div>
                            </div>
                        </div>

                        <div className="flex items-center justify-between p-4 rounded-xl bg-white/5">
                            <div>
                                <div className="font-semibold text-white">100+ invoices/month (Established)</div>
                                <div className="text-sm text-white/60">Saves 31.6 hours/month</div>
                            </div>
                            <div className="text-right">
                                <div className="text-2xl font-bold text-green-400">R 236,400/year</div>
                                <div className="text-xs text-white/40">5,533% ROI</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-8">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="font-semibold text-white mb-1">Day 1: Setup (30 minutes)</h3>
                                <p className="text-sm text-white/60">Add business details, upload logo, customize invoice template</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="font-semibold text-white mb-1">Week 1: Import Clients (1 hour)</h3>
                                <p className="text-sm text-white/60">Upload existing client list, set payment terms, configure defaults</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="font-semibold text-white mb-1">Week 2: First Invoices (15 minutes)</h3>
                                <p className="text-sm text-white/60">Send first automated invoices, set up payment reminders</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="font-semibold text-white mb-1">Month 1: Full ROI Realized</h3>
                                <p className="text-sm text-white/60">Start seeing time savings, faster payments, and reduced errors immediately</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-12 text-center">
                    <p className="text-white/60 mb-4">Start saving time and money with automated invoicing</p>
                    <Link
                        href="/login"
