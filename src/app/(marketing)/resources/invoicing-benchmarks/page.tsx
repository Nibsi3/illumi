            ...
            <main className="relative z-10 mx-auto max-w-6xl px-6 pt-32 md:pt-40 pb-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                    <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-6">
                        <div className="flex items-center gap-3 mb-3">
                            <div className="p-2 rounded-lg bg-white/10">
                                <IconCurrencyDollar className="h-5 w-5 text-white" />
                            </div>
                            <div className="text-sm text-white/60">Average Invoice Value</div>
                        </div>
                        <div className="text-3xl font-bold mb-1">R 13,800</div>
                        <div className="text-xs text-white/40">Across all industries</div>
                    </div>
                    ...
                    <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-6">
                        <div className="flex items-center gap-3 mb-3">
                            ...
                            <div className="text-sm text-white/60">Average Payment Time</div>
                        </div>
                        <div className="text-3xl font-bold mb-1">31 days</div>
                        <div className="text-xs text-white/40">From invoice date</div>
                    </div>
                    ...
                    <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-6">
                        <div className="flex items-center gap-3 mb-3">
                            ...
                            <div className="text-sm text-white/60">Late Payment Rate</div>
                        </div>
                        <div className="text-3xl font-bold mb-1">27.5%</div>
                        <div className="text-xs text-white/40">Paid after due date</div>
                    </div>
                </div>
                ...
                <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] overflow-hidden mb-12">
                    <div className="p-6 border-b border-white/10">
                        ...
                        <p className="text-sm text-white/60 mt-1">Data from January 2024 - December 2024</p>
                    </div>
                        ...
                        <table className="w-full">
                            <thead className="border-b border-white/10">
                                <tr className="text-left">
                                    <th className="p-4 text-sm font-semibold text-white/80">Industry</th>
                                    <th className="p-4 text-sm font-semibold text-white/80">Avg Invoice</th>
                                    <th className="p-4 text-sm font-semibold text-white/80">Avg Payment Days</th>
                                    <th className="p-4 text-sm font-semibold text-white/80">Late Pay Rate</th>
                                    <th className="p-4 text-sm font-semibold text-white/80">Trend</th>
                                </tr>
                            </thead>
                            <tbody>
                                {industryData.map((row, idx) => (
                                    <tr key={row.industry} className={idx !== industryData.length - 1 ? "border-b border-white/5" : ""}>
                                        <td className="p-4 text-white">{row.industry}</td>
                                        <td className="p-4 text-white font-semibold">{row.avgInvoice}</td>
                                        <td className="p-4">
                                            <span className={row.avgPaymentDays > 35 ? "text-red-400" : row.avgPaymentDays < 25 ? "text-green-400" : "text-white"}>
                                                {row.avgPaymentDays} days
                                            </span>
                                        </td>
                                        <td className="p-4">
                                            <span className={parseFloat(row.latePayRate) > 30 ? "text-red-400" : parseFloat(row.latePayRate) < 20 ? "text-green-400" : "text-white"}>
                                                {row.latePayRate}
                                            </span>
                                        </td>
                                        <td className="p-4">
                                            <span className={`inline-flex items-center gap-1 text-xs ${
                                                row.trend === "up" ? "text-red-400" : row.trend === "down" ? "text-green-400" : "text-white/60"
                                            }`}>
                                                {row.trend === "up" && "↑ Slower"}
                ...
                <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-8 mb-12">
                    ...
                    <div className="space-y-6">
                        <div>
                            <h3 className="text-lg font-semibold mb-2 text-white">Construction has the longest payment cycles</h3>
                        ...
                        <div>
                            <h3 className="text-lg font-semibold mb-2 text-white">Retail gets paid fastest</h3>
                            <p className="text-white/60 leading-relaxed">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold mb-2 text-white">IT & Software commands highest invoice values</h3>
                            <p className="text-white/60 leading-relaxed">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold mb-2 text-white">Late payments are increasing in professional services</h3>
                            <p className="text-white/60 leading-relaxed">
                ...
                <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <h3 className="font-semibold mb-2 text-white">1. Set Clear Payment Terms</h3>
                        ...
                        <div>
                            <h3 className="font-semibold mb-2 text-white">2. Send Invoices Immediately</h3>
                            <p className="text-sm text-white/60">
                        ...
                        <div>
                            <h3 className="font-semibold mb-2 text-white">3. Enable Online Payments</h3>
                            <p className="text-sm text-white/60">
                        ...
                        <div>
                            <h3 className="font-semibold mb-2 text-white">4. Send Payment Reminders</h3>
                            <p className="text-sm text-white/60">
                ...
                <div className="mt-12 text-center">
                    <p className="text-white/60 mb-4">Track your own invoicing metrics with Illumi</p>
                    <Link
                        href="/login"
