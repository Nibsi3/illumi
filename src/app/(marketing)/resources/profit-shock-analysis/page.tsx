            ...
            <main className="relative z-10 mx-auto max-w-6xl px-6 pt-32 md:pt-40 pb-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                    <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-6">
                        <div className="text-sm text-white/60 mb-1">Experience Profit Shock</div>
                        <div className="text-3xl font-bold text-red-400">78%</div>
                        <div className="text-xs text-white/40 mt-1">Of SMEs in first 3 years</div>
                    </div>

                    <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-6">
                        <div className="text-sm text-white/60 mb-1">Avg Impact on Profit</div>
                        <div className="text-3xl font-bold text-red-400">-42%</div>
                        <div className="text-xs text-white/40 mt-1">In the shock month</div>
                    </div>

                    <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-6">
                        <div className="text-sm text-white/60 mb-1">Recovery Time</div>
                        <div className="text-3xl font-bold">3.2 months</div>
                        <div className="text-xs text-white/40 mt-1">To return to baseline</div>
                    </div>
                </div>
                ...
                <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-8 mb-12">
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            <div key={shock.type} className="rounded-xl bg-white/5 p-6">
                                <div className="flex items-start justify-between mb-4">
                                    <div className="flex-1">
                                        <h3 className="text-lg font-semibold text-white mb-1">{shock.type}</h3>
                                        <p className="text-sm text-white/60">{shock.frequency}% of businesses experience this</p>
                                    </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div>
                                        <div className="text-xs text-white/40 mb-1">Avg Cost</div>
                                        <div className="text-lg font-bold text-white">{shock.avgCost}</div>
                                    </div>
                                    <div>
                                        <div className="text-xs text-white/40 mb-1">Profit Impact</div>
                                        <div className="text-lg font-bold text-red-400">{shock.impact}</div>
                                    </div>
                                    <div>
                                        <div className="text-xs text-white/40 mb-1">Recovery Time</div>
                                        <div className="text-lg font-bold text-white">{shock.recovery}</div>
                                    </div>
                                </div>
                            </div>
                        ))}
                ...
                <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-8 mb-12">
                    ...
                    <div className="space-y-6">
                        <div>
                            <h3 className="text-lg font-semibold mb-4 text-white">Typical Recovery Timeline</h3>
                            <div className="space-y-3">
                                {[
                                    ...
                                    <div key={stage.month} className="flex items-center gap-4">
                                        <div className="w-32 text-white/60 text-sm">{stage.month}</div>
                                        <div className="flex-1">
                ...
                <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <h3 className="font-semibold mb-2 text-white">1. Build 3-6 Month Cash Reserve</h3>
                        ...
                        <div>
                            <h3 className="font-semibold mb-2 text-white">2. Get Business Insurance</h3>
                            <p className="text-sm text-white/60 mb-2">
                        ...
                        <div>
                            <h3 className="font-semibold mb-2 text-white">3. Diversify Revenue Streams</h3>
                            <p className="text-sm text-white/60 mb-2">
                        ...
                        <div>
                            <h3 className="font-semibold mb-2 text-white">4. Maintain Flexible Costs</h3>
                            <p className="text-sm text-white/60 mb-2">
                        ...
                        <div>
                            <h3 className="font-semibold mb-2 text-white">5. Secure Credit Line Before You Need It</h3>
                            <p className="text-sm text-white/60 mb-2">
                        ...
                        <div>
                            <h3 className="font-semibold mb-2 text-white">6. Improve Payment Terms</h3>
                            <p className="text-sm text-white/60 mb-2">
                ...
                <div className="mt-12 text-center">
                    <p className="text-white/60 mb-4">Track expenses and build cash reserves with Illumi</p>
                    <Link
                        href="/login"
