            ...
            <main className="relative z-10 mx-auto max-w-6xl px-6 pt-32 md:pt-40 pb-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                    <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-6">
                        <div className="text-sm text-white/60 mb-1">Fastest Paying Industry</div>
                        <div className="text-2xl font-bold text-green-400">Healthcare</div>
                        <div className="text-xs text-white/40 mt-1">16 days average</div>
                    </div>

                    <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-6">
                        <div className="text-sm text-white/60 mb-1">Slowest Paying Industry</div>
                        <div className="text-2xl font-bold text-red-400">Government</div>
                        <div className="text-xs text-white/40 mt-1">68 days average</div>
                    </div>

                    <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-6">
                        <div className="text-sm text-white/60 mb-1">Payment Gap</div>
                        <div className="text-2xl font-bold">4.3x</div>
                        <div className="text-xs text-white/40 mt-1">Slowest vs fastest</div>
                    </div>
                </div>

                {/* Fastest Paying */}
                <div className="rounded-2xl border border-green-500/20 bg-[#0a0a0a] p-8 mb-12">
                    ...
                    <div className="space-y-4">
                        {fastestPaying.map((item) => (
                            <div key={item.rank} className="rounded-xl bg-white/5 p-6 border border-green-500/10">
                                ...
                                <div className="grid grid-cols-2 gap-4 mt-4">
                                    <div>
                                        <div className="text-xs text-white/40 mb-1">Average Payment Time</div>
                                        <div className="text-2xl font-bold text-green-400">{item.avgDays} days</div>
                                    </div>
                                    <div>
                                        <div className="text-xs text-white/40 mb-1">On-Time Payment Rate</div>
                ...
                {/* Slowest Paying */}
                <div className="rounded-2xl border border-red-500/20 bg-[#0a0a0a] p-8 mb-12">
                    <div className="flex items-center gap-3 mb-6">
                    ...
                    <div className="space-y-4">
                        {slowestPaying.map((item) => (
                            <div key={item.rank} className="rounded-xl bg-white/5 p-6 border border-red-500/10">
                                <div className="flex items-start justify-between mb-3">
                                    <div className="flex items-center gap-4">
                ...
                <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-8 mb-12">
                    ...
                    <div className="space-y-6">
                        <div>
                            <h3 className="text-lg font-semibold mb-2 text-white">Government contracts = cash flow risk</h3>
                        ...
                        <div>
                            <h3 className="text-lg font-semibold mb-2 text-white">Healthcare pays fastest due to insurance</h3>
                            <p className="text-white/60 leading-relaxed">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold mb-2 text-white">Company size matters more than industry</h3>
                            <p className="text-white/60 leading-relaxed">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold mb-2 text-white">Tech startups prioritize vendor relationships</h3>
                            <p className="text-white/60 leading-relaxed">
                ...
                <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <h3 className="font-semibold mb-2 text-white">Require Deposits</h3>
                        ...
                        <div>
                            <h3 className="font-semibold mb-2 text-white">Milestone Billing</h3>
                            <p className="text-sm text-white/60">
                        ...
                        <div>
                            <h3 className="font-semibold mb-2 text-white">Charge Premium Rates</h3>
                            <p className="text-sm text-white/60">
                        ...
                        <div>
                            <h3 className="font-semibold mb-2 text-white">Diversify Client Base</h3>
                            <p className="text-sm text-white/60">
                ...
                <div className="mt-12 text-center">
                    <p className="text-white/60 mb-4">Track which clients pay fastest with Illumi analytics</p>
                    <Link
                        href="/login"
