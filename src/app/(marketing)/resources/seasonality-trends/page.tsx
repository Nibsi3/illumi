            ...
            <main className="relative z-10 mx-auto max-w-6xl px-6 pt-32 md:pt-40 pb-20">
                ...
                <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-8 mb-12">
                    ...
                    <div className="space-y-3">
                        {monthlyData.map((data) => (
                            <div key={data.month} className="rounded-xl bg-white/5 p-6">
                                <div className="flex items-center justify-between mb-4">
                                    <div className="flex items-center gap-4">
                                        <IconCalendar className="h-5 w-5 text-white/40" />
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                    <div>
                                        <div className="text-xs text-white/40 mb-2">Invoicing Activity</div>
                                        ...
                                        <div className="text-sm text-white/60 mt-1">{data.invoicing}% of peak</div>
                                    </div>

                                    <div>
                                        <div className="text-xs text-white/40 mb-2">Expense Level</div>
                                        <div className="w-full bg-white/10 rounded-full h-2">
                                            <div 
                                        ...
                                        <div className="text-sm text-white/60 mt-1">{data.expenses}% of peak</div>
                                    </div>

                                    <div>
                                        <div className="text-xs text-white/40 mb-2">Net Cash Flow</div>
                                        <div className="w-full bg-white/10 rounded-full h-2">
                                            <div 
                                        ...
                                        <div className="text-sm text-white/60 mt-1">{data.netFlow > 0 ? 'Positive' : 'Negative'}</div>
                                    </div>
                                </div>

                                <p className="text-sm text-white/60">{data.trend}</p>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-8 mb-12">
                    ...
                    <div className="space-y-6">
                        <div className="rounded-xl bg-white/5 p-6">
                            <h3 className="font-semibold mb-3 text-white">Retail & E-commerce</h3>
                            <p className="text-sm text-white/60 mb-3">
                                <strong className="text-white">Peak:</strong> November-December (Black Friday, Christmas)<br/>
                                <strong className="text-white">Low:</strong> January-February (post-holiday slump)<br/>
                                <strong className="text-white">Planning tip:</strong> Build inventory in October, hire seasonal staff in November
                            </p>
                        </div>

                        <div className="rounded-xl bg-white/5 p-6">
                            <h3 className="font-semibold mb-3 text-white">Professional Services</h3>
                            <p className="text-sm text-white/60 mb-3">
                                <strong className="text-white">Peak:</strong> March, June (quarter/year-end)<br/>
                                <strong className="text-white">Low:</strong> December-January (holidays)<br/>
                                <strong className="text-white">Planning tip:</strong> Front-load work in Feb-May, use slow months for business development
                            </p>
                        </div>

                        <div className="rounded-xl bg-white/5 p-6">
                            <h3 className="font-semibold mb-3 text-white">Construction & Trades</h3>
                            <p className="text-sm text-white/60 mb-3">
                                <strong className="text-white">Peak:</strong> September-November (spring/summer)<br/>
                                <strong className="text-white">Low:</strong> June-July (winter weather)<br/>
                                <strong className="text-white">Planning tip:</strong> Schedule major projects for spring, use winter for maintenance
                            </p>
                        </div>

                        <div className="rounded-xl bg-white/5 p-6">
                            <h3 className="font-semibold mb-3 text-white">Hospitality & Tourism</h3>
                            <p className="text-sm text-white/60 mb-3">
                                <strong className="text-white">Peak:</strong> December-January, June-July (school holidays)<br/>
                                <strong className="text-white">Low:</strong> May, August (between holiday periods)<br/>
                                <strong className="text-white">Planning tip:</strong> Maximize pricing during peak, offer specials in shoulder months
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <h3 className="font-semibold mb-2 text-white">1. Build Cash Reserves in Peak Months</h3>
                            <p className="text-sm text-white/60">
                        ...
                        <div>
                            <h3 className="font-semibold mb-2 text-white">2. Adjust Marketing Spend</h3>
                            <p className="text-sm text-white/60">
                        ...
                        <div>
                            <h3 className="font-semibold mb-2 text-white">3. Flexible Staffing</h3>
                            <p className="text-sm text-white/60">
                        ...
                        <div>
                            <h3 className="font-semibold mb-2 text-white">4. Negotiate Payment Terms</h3>
                            <p className="text-sm text-white/60">
                        ...
                        <div>
                            <h3 className="font-semibold mb-2 text-white">5. Plan Major Expenses</h3>
                            <p className="text-sm text-white/60">
                        ...
                        <div>
                            <h3 className="font-semibold mb-2 text-white">6. Diversify Revenue Streams</h3>
                            <p className="text-sm text-white/60">
                ...
                <div className="mt-12 text-center">
                    <p className="text-white/60 mb-4">Track your seasonal patterns and plan ahead with Illumi analytics</p>
                    <Link
                        href="/login"
