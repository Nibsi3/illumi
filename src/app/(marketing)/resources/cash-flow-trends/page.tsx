            ...
            <main className="relative z-10 mx-auto max-w-6xl px-6 pt-32 md:pt-40 pb-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
                    <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-6">
                        <div className="text-sm text-white/60 mb-1">Avg Quarterly Income</div>
                        <div className="text-3xl font-bold">R 164.5k</div>
                        <div className="text-xs text-white/40 mt-1">2024 average</div>
                    </div>

                    <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-6">
                        <div className="text-sm text-white/60 mb-1">Avg Quarterly Expenses</div>
                        <div className="text-3xl font-bold">R 148.3k</div>
                        <div className="text-xs text-white/40 mt-1">2024 average</div>
                    </div>

                    <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-6">
                        <div className="text-sm text-white/60 mb-1">Avg Net Cash Flow</div>
                        <div className="text-3xl font-bold text-green-400">R 16.3k</div>
                        <div className="text-xs text-white/40 mt-1">Per quarter</div>
                    </div>

                    <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-6">
                        <div className="text-sm text-white/60 mb-1">Best Quarter</div>
                        <div className="text-3xl font-bold">Q4</div>
                        <div className="text-xs text-white/40 mt-1">+71% vs worst</div>
                    </div>
                </div>
                ...
                <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-8 mb-12">
                    ...
                    <div className="space-y-6">
                        {quarterlyData.map((quarter) => (
                            <div key={quarter.quarter} className="rounded-xl bg-white/5 p-6">
                                <div className="flex items-center justify-between mb-4">
                                    <div>
                                        <h3 className="text-xl font-semibold">{quarter.quarter}</h3>
                                        <p className="text-sm text-white/60 mt-1">{quarter.notes}</p>
                                    </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div>
                                        <div className="text-xs text-white/40 mb-1">Avg Income</div>
                                        <div className="text-2xl font-bold">R {(quarter.avgIncome / 1000).toFixed(0)}k</div>
                                    </div>
                                    <div>
                                        <div className="text-xs text-white/40 mb-1">Avg Expenses</div>
                                        <div className="text-2xl font-bold">R {(quarter.avgExpenses / 1000).toFixed(0)}k</div>
                                    </div>
                                    <div>
                                        <div className="text-xs text-white/40 mb-1">Net Cash Flow</div>
                                        <div className={`text-2xl font-bold ${quarter.netCashFlow > 15000 ? 'text-green-400' : quarter.netCashFlow > 10000 ? 'text-white' : 'text-yellow-400'}`}>
                ...
                <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] overflow-hidden mb-12">
                    <div className="p-6 border-b border-white/10">
                        ...
                        <p className="text-sm text-white/60 mt-1">Net cash flow as percentage of revenue</p>
                    </div>
                        ...
                        <table className="w-full">
                            <thead className="border-b border-white/10">
                                <tr className="text-left">
                                    ...
                                    <th className="p-4 text-sm font-semibold text-white/80">Q1 2024</th>
                                    <th className="p-4 text-sm font-semibold text-white/80">Q2 2024</th>
                                    <th className="p-4 text-sm font-semibold text-white/80">Q3 2024</th>
                                    <th className="p-4 text-sm font-semibold text-white/80">Q4 2024</th>
                                    <th className="p-4 text-sm font-semibold text-white/80">Annual Avg</th>
                                </tr>
                            </thead>
                            <tbody>
                                {sectorTrends.map((row, idx) => (
                                    <tr key={row.sector} className={idx !== sectorTrends.length - 1 ? "border-b border-white/5" : ""}>
                                        <td className="p-4 text-white">{row.sector}</td>
                                        <td className="p-4 text-white/70">{row.q1}%</td>
                                        <td className="p-4 text-white/70">{row.q2}%</td>
                                        <td className="p-4 text-white/70">{row.q3}%</td>
                                        <td className="p-4 text-white/70">{row.q4}%</td>
                                        <td className="p-4">
                                            <span className={`font-semibold ${
                                                row.annual > 20 ? 'text-green-400' : 
                                                row.annual > 15 ? 'text-white' : 'text-yellow-400'
                                            }`}>
                                                {row.annual}%
                                            </span>
                                        </td>
                ...
                <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-8 mb-12">
                    ...
                    <div className="space-y-6">
                        <div>
                            <h3 className="text-lg font-semibold mb-2 text-white">Q4 is the strongest quarter for most SMEs</h3>
                        ...
                        <div>
                            <h3 className="text-lg font-semibold mb-2 text-white">Q3 is the weakest quarter</h3>
                            <p className="text-white/60 leading-relaxed">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold mb-2 text-white">IT & Software maintains consistent margins</h3>
                            <p className="text-white/60 leading-relaxed">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold mb-2 text-white">Construction struggles with cash flow</h3>
                            <p className="text-white/60 leading-relaxed">
                ...
                <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <h3 className="font-semibold mb-2 text-white">Build Q4 Cash Reserves in Q2</h3>
                        ...
                        <div>
                            <h3 className="font-semibold mb-2 text-white">Reduce Fixed Costs in Q3</h3>
                            <p className="text-sm text-white/60">
                        ...
                        <div>
                            <h3 className="font-semibold mb-2 text-white">Maximize Q4 Opportunities</h3>
                            <p className="text-sm text-white/60">
                        ...
                        <div>
                            <h3 className="font-semibold mb-2 text-white">Plan for Q1 Recovery</h3>
                            <p className="text-sm text-white/60">
                ...
                <div className="mt-12 text-center">
                    <p className="text-white/60 mb-4">Track your quarterly cash flow trends with Illumi</p>
                    <Link
                        href="/login"
