        ...
        <div className="min-h-screen bg-black text-white grainy-gradient">
            ...
            <main className="relative z-10 mx-auto max-w-6xl px-6 pt-32 md:pt-40 pb-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                    <div className="rounded-2xl border border-green-500/20 bg-[#0a0a0a] p-8">
                        ...
                        <div className="space-y-6">
                            <div>
                                <div className="text-sm text-white/60 mb-1">Avg Payment Time</div>
                                <div className="text-4xl font-bold text-green-400">18 days</div>
                            </div>

                            <div>
                                <div className="text-sm text-white/60 mb-1">On-Time Payment Rate</div>
                                <div className="text-4xl font-bold text-green-400">82%</div>
                            </div>

                            <div>
                                <div className="text-sm text-white/60 mb-1">Late Payment Rate</div>
                                <div className="text-4xl font-bold text-green-400">12%</div>
                            </div>

                            <div>
                                <div className="text-sm text-white/60 mb-1">Non-Payment Rate</div>
                                <div className="text-4xl font-bold text-green-400">6%</div>
                            </div>
                        </div>
                    </div>

                    <div className="rounded-2xl border border-blue-500/20 bg-[#0a0a0a] p-8">
                        <div className="flex items-center gap-3 mb-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="rounded-xl bg-green-500/5 border border-green-500/20 p-6">
                                ...
                                <p className="text-sm text-white/60 leading-relaxed">
                                    Recurring invoices get paid <strong className="text-white">47% faster</strong> (18 vs 34 days). 
                            ...
                            <div className="rounded-xl bg-green-500/5 border border-green-500/20 p-6">
                                ...
                                <p className="text-sm text-white/60 leading-relaxed">
                                    <strong className="text-white">82% on-time rate</strong> vs 58% for one-off invoices. 
                            ...
                            <div className="rounded-xl bg-green-500/5 border border-green-500/20 p-6">
                                ...
                                <p className="text-sm text-white/60 leading-relaxed">
                                    Only <strong className="text-white">6% non-payment</strong> vs 11% for one-off. 
                            ...
                            <div className="rounded-xl bg-blue-500/5 border border-blue-500/20 p-6">
                                ...
                                <p className="text-sm text-white/60 leading-relaxed">
                                    Average one-off invoice: <strong className="text-white">R 18,500</strong> vs R 8,200 for recurring. 
                        ...
                        <table className="w-full">
                            <thead className="border-b border-white/10">
                                <tr className="text-left">
                                    <th className="p-4 text-sm font-semibold text-white/80">Metric</th>
                                    ...
                                    <th className="p-4 text-sm font-semibold text-white/80">Winner</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr className="border-b border-white/5">
                                    <td className="p-4 text-white">Cash Flow Predictability</td>
                ...
                <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-8 mb-12">
                    ...
                    <div className="space-y-6">
                        <div>
                            <h3 className="text-lg font-semibold mb-2 text-white">Recurring revenue = 5x customer lifetime value</h3>
                        ...
                        <div>
                            <h3 className="text-lg font-semibold mb-2 text-white">Businesses with 60%+ recurring revenue grow 3x faster</h3>
                            <p className="text-white/60 leading-relaxed">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold mb-2 text-white">Recurring models command higher valuations</h3>
                            <p className="text-white/60 leading-relaxed">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold mb-2 text-white">Hybrid model is optimal for most SMEs</h3>
                            <p className="text-white/60 leading-relaxed">
                ...
                <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] p-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <h3 className="font-semibold mb-2 text-white">1. Convert Projects to Retainers</h3>
                        ...
                        <div>
                            <h3 className="font-semibold mb-2 text-white">2. Create Subscription Tiers</h3>
                            <p className="text-sm text-white/60 mb-2">
                        ...
                        <div>
                            <h3 className="font-semibold mb-2 text-white">3. Offer Prepaid Packages</h3>
                            <p className="text-sm text-white/60 mb-2">
                        ...
                        <div>
                            <h3 className="font-semibold mb-2 text-white">4. Add Managed Services</h3>
                            <p className="text-sm text-white/60 mb-2">
                        ...
                        <div>
                            <h3 className="font-semibold mb-2 text-white">5. Build SaaS Products</h3>
                            <p className="text-sm text-white/60 mb-2">
                        ...
                        <div>
                            <h3 className="font-semibold mb-2 text-white">6. Create Membership Programs</h3>
                            <p className="text-sm text-white/60 mb-2">
                ...
                <div className="mt-12 text-center">
                    <p className="text-white/60 mb-4">Manage recurring and one-off invoices seamlessly with Illumi</p>
                    <Link
                        href="/login"
