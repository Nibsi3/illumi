                            ...
                            <div className="rounded-3xl overflow-hidden bg-[#0a0a0a] border border-white/10 shadow-2xl">
                                ...
                                <div className="p-8 overflow-x-auto">
                                    <pre className="text-sm font-mono leading-relaxed"><code className="language-javascript">
                                        ...
                                        <span className="text-blue-300">methods</span><span className="text-white/60">:</span> <span className="text-white/60">[</span><span className="text-emerald-400">'email'</span><span className="text-white/60">,</span> <span className="text-emerald-400">'whatsapp'</span><span className="text-white/60">]</span>
                                        <span className="text-white/60">{`});`}</span>
