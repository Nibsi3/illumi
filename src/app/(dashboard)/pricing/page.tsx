        ...
        <div className="max-w-5xl mx-auto py-12 px-6 pb-32">
            ...
            <div className="text-center mb-12">
                ...
                <p className="text-lg text-neutral-400 max-w-2xl mx-auto">
                    Hi Cameron, Your trial ends in 11 days. Choose a plan now to continue using all of Emini's features and secure our limited-time discount—save 50% on the Pro plan.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                ...
                <div className="p-8 rounded-xl bg-[#09090b] border border-white/5">
                    ...
                    <Button
                        ...
                        onClick={() => router.push("/settings/billing?plan=starter")}
                    >
                        Choose starter plan
                    </Button>
                </div>
