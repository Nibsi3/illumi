    ...
    return (
        <div className="h-full bg-background text-foreground font-sans flex overflow-hidden">
            ...
            <div className="flex-1 flex flex-col relative h-full bg-background">
                ...
                <div className="flex-1 overflow-y-auto pb-[420px] no-scrollbar">
                                    ...
                                    <div className="flex justify-between items-start">
                                        ...
                                        >
                                            {logo ? (
                                                ...
                                                <>
                                                    <Plus className="h-6 w-6 mb-1 group-hover:scale-110 transition-transform text-neutral-400" />
                                                    <span className="text-[10px] font-bold uppercase tracking-widest text-neutral-400">Logo</span>
                                                </>
                                            )}
                                            <input
                                                type="file"
            ...
            {paymentMethod === 'paygate' && (
                <div className="fixed left-1/2 -translate-x-1/2 z-40 w-[min(560px,calc(100vw-24px))] bottom-24 md:bottom-6">
                    <div className="bg-card border border-border p-6 rounded-2xl relative overflow-hidden hover:border-border transition-all">
