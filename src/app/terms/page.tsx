        ...
        <div className="bg-background text-foreground grainy-gradient">
            ...
            <main className="mx-auto max-w-4xl px-6 pb-20">
                ...
                <div className="mt-10 space-y-8 text-muted-foreground leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-lg font-semibold text-foreground">7. Availability and changes</h2>
                        <p className="mt-2">
                    ...
                    <section>
                        <h2 className="text-lg font-semibold text-foreground">8. Disclaimers and limitation of liability</h2>
                        <p className="mt-2">
                    ...
                    <section>
                        ...
                        <p className="mt-2">
                            For questions about these Terms, contact <span className="text-foreground">info@illumi.co.za</span>.
                        </p>
                    </section>
