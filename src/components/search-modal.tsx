...
export function SearchModal({ open, onOpenChange }: SearchModalProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-2xl p-0 bg-[#0a0a0a] border border-white/10 rounded-xl overflow-hidden gap-0">
                <VisuallyHidden>
                ...
                <div className="flex items-center gap-3 px-4 py-3 border-b border-white/10">
                    ...
                    <Input
                        ...
                        className="flex-1 border-0 bg-transparent text-white placeholder:text-neutral-500 focus-visible:ring-0 focus-visible:ring-offset-0 text-base"
                        autoFocus
                    />
                </div>
                                ...
                                return (
                                    <div
                                        ...
                                        className={cn(
                                            ...
                                            selectedIndex === globalIndex ? "bg-white/5" : "hover:bg-white/5"
                                        )}
                                    >
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            >
                                                <IconCopy className="h-4 w-4 text-neutral-500" />
                                            </button>
                                            <button 
                                                onClick={(e) => {
                                                    e.stopPropagation()
                ...
                {/* Footer */}
                <div className="flex items-center justify-end gap-4 px-4 py-2 border-t border-white/10">
                    <div className="flex items-center gap-1">
                        <kbd className="px-1.5 py-0.5 text-[10px] bg-white/5 border border-white/10 rounded text-neutral-500">↑</kbd>
                        <kbd className="px-1.5 py-0.5 text-[10px] bg-white/5 border border-white/10 rounded text-neutral-500">↓</kbd>
                        <span className="text-[10px] text-neutral-500 ml-1">navigate</span>
                    </div>
                    <div className="flex items-center gap-1">
                        <kbd className="px-1.5 py-0.5 text-[10px] bg-white/5 border border-white/10 rounded text-neutral-500">↵</kbd>
                        <span className="text-[10px] text-neutral-500 ml-1">select</span>
                    </div>
                </div>
            </DialogContent>
        </Dialog>
